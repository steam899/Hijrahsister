...
// Fungsi global untuk memadam fail imej daripada form
...
window.renderForm = function(collectionId, item = null) {
    ...
    // PANDUAN FONTAWESOME ICON (DIPAPARKAN PADA RUANG FORM UNTUK RUJUKAN ADMIN)
    html += `
        <div class="pt-6 border-t border-gray-800 bg-gray-900/30 p-6 rounded-2xl border border-gray-850">
            <h4 class="text-xs font-bold uppercase tracking-widest text-pink-400 mb-3"><i class="fa-solid fa-circle-info mr-2"></i> Panduan Kod Icon (FontAwesome)</h4>
            <p class="text-xs text-gray-400 mb-4">Salin (Copy) kod di bawah dan paste pada ruangan <b>Icon Class</b> di atas untuk menukar reka bentuk:</p>
            <div class="grid grid-cols-2 gap-3 text-xs">
                <div class="flex items-center gap-2 bg-gray-950 p-2 rounded-lg"><i class="fa-solid fa-users text-pink-400"></i> <span>fa-solid fa-users</span> (Usrah)</div>
                <div class="flex items-center gap-2 bg-gray-950 p-2 rounded-lg"><i class="fa-solid fa-book-quran text-pink-400"></i> <span>fa-solid fa-book-quran</span> (Al-Quran)</div>
                <div class="flex items-center gap-2 bg-gray-950 p-2 rounded-lg"><i class="fa-solid fa-mug-hot text-pink-400"></i> <span>fa-solid fa-mug-hot</span> (Book Club)</div>
                <div class="flex items-center gap-2 bg-gray-950 p-2 rounded-lg"><i class="fa-solid fa-microphone-lines text-pink-400"></i> <span>fa-solid fa-microphone-lines</span> (Talks)</div>
                <div class="flex items-center gap-2 bg-gray-950 p-2 rounded-lg"><i class="fa-solid fa-leaf text-pink-400"></i> <span>fa-solid fa-leaf</span> (Retreats)</div>
                <div class="flex items-center gap-2 bg-gray-950 p-2 rounded-lg"><i class="fa-solid fa-headphones text-pink-400"></i> <span>fa-solid fa-headphones</span> (Podcasts)</div>
            </div>
        </div>`;
